...
namespace Client
{
    ...
    {      
        ...
        {
            (Application.OpenForms["ChatApplication"] as ChatApplication).listBox_chat.Items.Add($"{nickname} : {message}");
        }
        ...
        {
            (Application.OpenForms["ChatApplication"] as ChatApplication).listBox_nicknames.Items.Add(nickname);
        } 
    }
}
